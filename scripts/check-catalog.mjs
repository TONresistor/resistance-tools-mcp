...
assert.ok(readme.includes("Marketplace/source: `resistance-tools`"));
assert.ok(readme.includes("Plugin and MCP server: `resistance-tools-mcp`"));
assert.ok(readme.includes("Agent Skill: `resistance-tools-skill`"));
assert.match(readme, /codex plugin marketplace add TONresistor\/resistance-tools-mcp@main/);
...
assert.match(readme, /claude mcp login resistance-tools-mcp/);
...
assert.match(readme, /codex mcp logout resistance-tools/);
assert.match(readme, /codex mcp remove resistance-tools/);
assert.match(readme, /codex mcp logout resistance-tools-mcp/);
assert.match(readme, /codex mcp remove resistance-tools-mcp/);
assert.match(readme, /codex plugin remove resistance-tools@resistance-tools/);
assert.match(readme, /codex plugin remove resistance-tools-mcp@resistance-tools/);
assert.match(readme, /codex plugin marketplace remove resistance-tools/);
assert.match(readme, /claude mcp logout resistance-tools/);
assert.match(readme, /claude mcp remove resistance-tools/);
assert.match(readme, /claude mcp logout resistance-tools-mcp/);
assert.match(readme, /claude mcp remove resistance-tools-mcp/);
